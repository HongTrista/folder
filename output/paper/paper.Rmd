...
abstract: The data used in the paper was collected by the city government used for analyzed the poll engagement. Attitudes from residents toward each topic and the changes of response rate through time being discussed. The descriptive results illustrate that Front Yard Parking has the most issues, and the poll engagement performed poorly in April 2020. Non-response bias may exist with low engagement, which may cause misunderstanding for the government.
