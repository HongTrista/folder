...
```{r figure1,fig.cap="The total number of applications of each type",echo=FALSE,warning=FALSE}
...
```{r Figure3,fig.cap="Average engagement rate in each year",echo=FALSE,warning=FALSE}
